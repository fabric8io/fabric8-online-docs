[id="optimizing_ct_resources"]
= Optimizing {ct} resource usage

:context: optimizing_memory_usage

After creating your first quickstart project, you will now learn to optimize your memory usage in {ct} using the following steps:
...
include::modules/reducing_application_memory_usage.adoc[leveloffset=+1]
