...
See link:https://docs.openshift.io/getting-started-guide.html#advanced_che_features[Using advanced Che features] to learn more about effectively using your Che workspace. 
