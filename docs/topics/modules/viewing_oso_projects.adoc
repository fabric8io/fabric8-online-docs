...
* The *_username-stage_* project is for your personal use. Use this project to see the pods that are created when pipelines are triggered in {ct}. For maintenance, select this project and power down individual pods as required.
