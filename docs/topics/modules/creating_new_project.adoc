...
You have now completed the first task *Launch a sample quickstart application* in the *Test Iteration*, ensure that you change the state of the work item to *Closed* using the *Plan* tab.
endif::[]
