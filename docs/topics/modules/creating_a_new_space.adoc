...
. Click btn:[Create] to create your new space. The `How would you like to get started?` dialog box appears and offers the following options:
...
.. btn:[No thanks, take me to the _new_space_ dashboard]: Go to your new space dashboard to begin working in the space.
+
