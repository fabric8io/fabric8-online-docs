...
To start using {ct}, create a new Red Hat Developers (RHD) account or use an existing RHD or social media account.
...
. Click btn:[Sign Up]. You can register using an existing social or Red Hat account.
  ...
  * To register a new Red Hat account:
    ... At the {ct} Developer page, click btn:[Register].
