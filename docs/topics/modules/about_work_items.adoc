...
Work items can be grouped and categorized into various work item types depending on the template you select for a space. In addition, you can associate the work items to link:user-guide.html#about_iterations[Iterations] and sprints to track progress and plan work.
