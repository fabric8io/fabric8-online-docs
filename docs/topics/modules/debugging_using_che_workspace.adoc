...
. Scroll down in the displayed list and double-click the `get():Route` method. This is the Vert.x Router get method and maps to the HTTP verb GET. You now have the syntax for the get method.
+
