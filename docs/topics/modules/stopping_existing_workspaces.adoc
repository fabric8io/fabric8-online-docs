...
Each running workspace uses your OpenShift Online resources. The OpenShift Online Free Tier supports one running workspace at a time. When you start a new workspace, your other running workspace is automatically stopped. If it is not stopped, you must stop the running workspace for the older project before proceeding further.
