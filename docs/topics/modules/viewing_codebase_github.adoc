...
After reviewing your pipeline build running in {osio} and OpenShift Online, view your application link:getting-started-guide.html#about_application_codebases[codebase] in GitHub as follows:
