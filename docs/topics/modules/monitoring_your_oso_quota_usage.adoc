...
After <<reducing_project_memory_usage,optimizing the memory usage>> and committing and pushing your changes, view your memory quota details and compare with the earlier output.
