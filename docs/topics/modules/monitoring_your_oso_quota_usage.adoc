...
```
+
. Follow the instructions in <<reducing_hello_world_memory_usage>> and then resume the next steps here. This allows you to view your memory quota details before and after optimizing the memory usage and compare the two results.
