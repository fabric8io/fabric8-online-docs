...
A {ct} account with OpenShift Online provides two pods for your projects. To view how many of these resources are currently used in {ct}, navigate to the *Resources* page as follows:
