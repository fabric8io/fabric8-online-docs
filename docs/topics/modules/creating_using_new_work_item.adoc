...
+
. Click *Add Assignee* and add your name as the new assignee for this Work Item. Click *X* to close the menu and save changes. Assigning a Work Item sends that person an email notification. Depending on your mail server and account, this notification email may be arrive after a delay of several minutes. 
+
