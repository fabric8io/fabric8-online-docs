...
. Click the *Filter by <filter type>* drop-down to see a list of valid options for the selected filter type.
+
...
. Use the above procedure to add multiple filters successively. The added filters are displayed at the top of the filtered list.
For example, you can see all the _new tasks_ in your space by adding the *state: new* and the *workitemtype: Task* filters successively.
