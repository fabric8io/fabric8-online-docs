...
This glossary provides concise definitions of terms and explanations of concepts used in {prod} and in related documentation.
...
alternate dependency:: Dependencies recommended by {ct} analytics to replace restrictive licenses or usage outliers.
// endterm
...
security issue:: {ct} analytics examines the CVEs of all your dependencies and flags the ones with security vulnerabilities.
// endterm
...
unknown license:: Licenses unknown to {ct} analytics.
// endterm
