...
// term: 7af1ca55-3cfc-4893-87ff-b51288f4a119, en_EN
...
// term: 58cb3a32-65d9-4087-afbd-4d91035c8e9f, en_EN
product backlog item:: A small unit of work that can be completed by a team within an iteration and that can be broken down into tasks. It is commonly described in the format of an user story, with clearly specified requirements, an owner, an estimated size and ordered as per the order of execution.
// endterm
...
// term: d6cb8344-ce3b-4aed-b517-78303d253bcf, en_EN
