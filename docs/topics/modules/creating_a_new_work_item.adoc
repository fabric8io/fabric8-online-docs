...
You can create work items using the quick-add or the in-line add options. The in-line add option allows you to create work items with parent-child relations easily. To create independent work items use the quick-add option.
