...
After you create a space, you can link:getting-started-guide.html#creating_new_project-hello-world[create applications] using {ct} quickstart <<about_application_codebases,codebases>> or link:getting-started-guide.html#importing-existing-project[import existing codebases].
