...
// for planner user story
ifeval::["{secondary}" == "_modifywi"]
You can assign a work item to any of the collaborators in your space.
endif::[]

// for collaborator
ifeval::["{secondary}" == "_collaborators"]
After <<adding_collaborators,adding collaborators>> to your space, you can assign link:user-guide.html#about_work_items[work items] to them using the *Plan* tab:
endif::[]
