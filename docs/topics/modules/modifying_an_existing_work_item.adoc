...
Modify an existing Work Item by double-clicking on it in the `Backlog` or `Board` view. Alternatively, click the icon adjoining the Work Item and select *Open* from the displayed options. The detailed Work Item panel is displayed.
