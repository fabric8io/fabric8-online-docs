...
** The *1 pod* indicates that each of the application builds scales to one pod in OpenShift Online. The number of pods indicates the number of running instances of the application.
...
+
Your changes are now available on both *Stage* and *Run*. If you return to the *Deployments* tab, you can see the version for both *Stage* and *Run* are now version 1.0.2 of the application.
+
