...
. After you <<creating_a_new_iteration,create an iteration>> and <<associating_work_items_with_an_iteration,associate work items>> to the iteration, select the iteration to display the associated work items.
+
